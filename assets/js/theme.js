...
var navbarInit = function navbarInit() {
  ...
  if (navbar) {
    ...
    window.addEventListener(Events.SCROLL, function () {
      ...
      var alpha = 1 - scrollTop / windowHeight * 0.50; // Add class on scroll
      ...
      alpha >= 1 && (alpha = 1);
      navbar.style.backgroundColor = "rgba(".concat(colorRgb[0], ", ").concat(colorRgb[1], ", ").concat(colorRgb[2], ", ").concat(scrollTop == 0 ? 1 : alpha, ")");
